package com.demon.admin.core.thymeleaf.attribute;
...
public class SelectDictAttrProcessor extends AbstractAttributeTagProcessor {
    ...
    public static final String SELECTED_ATTR_NAME= "one-selected";
    public static final String EMPTY_ATTR_NAME= "one-empty";
